...
[**CoDaImpact**](https://lukece.github.io/CoDaImpact/) provides additional tools for the interpretation of regression CoDa models.
...
Below, we estimate a CoDa model that explains the market shares of [five segments of the car market](https://en.wikipedia.org/wiki/Car_classification#Market_segments) in France.
To illustrate the influence of the `HOUSEHOLD_EXPENDITURE` on the market shares in each segment we use a `VariationScenario()`.
